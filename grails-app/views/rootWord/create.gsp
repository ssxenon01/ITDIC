                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: rootWordInstance, field: 'alsoKnownAs', 'errors')}">
                                     <g:textArea cols="2" rows="25" name="alsoKnownAs" value="${rootWordInstance?.alsoKnownAs}" />
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: rootWordInstance, field: 'definition', 'errors')}">
                                     <g:textArea cols="2" rows="25" name="definition" value="${rootWordInstance?.definition}" />
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: rootWordInstance, field: 'formalDefinition', 'errors')}">
                                     <g:textArea cols="2" rows="25" name="formalDefinition" value="${rootWordInstance?.formalDefinition}" />
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: rootWordInstance, field: 'generalization', 'errors')}">
                                     <g:textArea cols="2" rows="25" name="generalization" value="${rootWordInstance?.generalization}" />
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: rootWordInstance, field: 'moreInformation', 'errors')}">
                                     <g:textArea cols="2" rows="25" name="moreInformation" value="${rootWordInstance?.moreInformation}" />
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: rootWordInstance, field: 'seeAlso', 'errors')}">
                                     <g:textArea cols="2" rows="25" name="seeAlso" value="${rootWordInstance?.seeAlso}" />
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: rootWordInstance, field: 'specialization', 'errors')}">
                                    <g:textArea cols="2" rows="25" name="specialization" value="${rootWordInstance?.specialization}" />
                                </td>
                            </tr>
